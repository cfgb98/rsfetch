...
A small neofetch-style system information tool written in Rust with support for Linux, macOS, and Windows. It prints host, OS, kernel, shell, uptime, CPU, memory/swap, disk usage, and the local network IP next to an auto-detected ASCII logo.
...
rsfetch [OPTIONS]
  ...
  --fields <LIST>     Comma-separated fields to show, in order
                      (host, os, kernel, shell, uptime, cpu, memory, swap, disks, local_ip)
  ...
  --logo <NAME>       auto (default), none, or arch/debian/fedora/ubuntu/mac/windows/wsl/generic
